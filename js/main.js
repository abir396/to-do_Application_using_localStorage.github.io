...
function Edit(count) 
{
    confirm("Are you sure to edit task no : "+(count+1)+" ?");
    var jsonVal = localStorage.getItem("jsondata");
    const json = JSON.parse(jsonVal);
    showModal();
...
function display_data() 
{
    ...
    if (json!=null){
            for (var i=0; i<json.length; i++)
            {
                ...
                cell5.innerHTML = "<img src='images/complete-task.png' alt='Complete' title='Complete-task' style='width: 25px ; height: 25px;' onclick='Completed("+i+"); return false;'>";
                cell6.innerHTML = "<img src='https://www.shutterstock.com/shutterstock/photos/711835882/display_1500/stock-vector-edit-icon-711835882.jpg' alt='Edit' title='Edit-task' style='width: 20px ; height: 20px;' onclick='Edit("+i+"); return false;'>";
