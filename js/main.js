...
function display_data() 
{
    ...
    if (json!=null){
            for (var i=0; i<json.length; i++)
            {
                ...
                cell5.innerHTML = "<button onclick='Completed("+i+"); return false;'>Completed</button>";
                cell6.innerHTML = "<button onclick='Edit("+i+"); return false;'>Edit</button>";
                cell7.innerHTML = "<button onclick='Delete("+i+"); return false;'>Delete</button>"; 
